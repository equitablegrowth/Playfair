...
window.playfair = (function () {
	...
	Playfair.prototype.style = function(parameters) {
		...
		// margins
		if (parameters['top_margin']===undefined){this.top_margin=25}else{this.top_margin=parameters['top_margin']}
		...
		// if(parameters['point_fillopacity']===undefined){this.point_fillopacity=1} else {this.point_fillopacity=parameters['point_fillopacity']}
