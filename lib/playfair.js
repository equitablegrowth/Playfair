			...
			if(this.group!=='none' && stacked==true){
				...
				for (var i=0;i<xaxis.length;i++){
					...
					for (var j=0;j<temp_array2.length;j++){
						...
						console.log('debugging negative bars',value,ymaxis,axes)
						...
						var bar_rect=snapobj.path('M'+x1+' '+y1+'L'+x2+' '+y1+'L'+x2+' '+y2+'L'+x1+' '+y2+'L'+x1+' '+y1).attr({orient:'vertical','data_type':'bar','data_label':temp_array2[j][1],'group':temp_array2[j][2],'class':'dataelement','shape-rendering':'crispEdges',fill:this.qualitative_color[j],'colorchange':'fill'})
			...
			if(this.group!=='none' && stacked==true){
				...
				for (var i=0;i<xaxis.length;i++){
					...
					for (var j=0;j<temp_array2.length;j++){
						...
						var bar_rect=snapobj.path('M'+x1+' '+y1+'L'+x2+' '+y1+'L'+x2+' '+y2+'L'+x1+' '+y2+'L'+x1+' '+y1).attr({orient:'horizontal','data_type':'bar','data_label':temp_array2[j][1],'group':temp_array2[j][2],'class':'dataelement','shape-rendering':'crispEdges',fill:this.qualitative_color[j],'colorchange':'fill'})
