	...
	if (playobj.group!=='none' && playobj.legend_location!=='none'){
		...
		if (playobj.legend_location=='float'){
			...
			for (var i=0;i<group.length;i++){
				...
				// temprect.drag(moveFuncfloat,function(){console.log('hi');x=this.attr('x');y=this.attr('y')});
				// temp.drag(moveFuncfloat,function(){console.log('hi');x=this.attr('x');y=this.attr('y')});
			}
			// floatgroup.drag()
