...
window.playfair = (function () {
	...
	// This sets up the variables for the plot. You have to pass a type, which corresponds
	...
	//			'line':['color'],
	//			'points':,['size',NaN]	
	Playfair.prototype.data = function(type,data,xvar,yvar,group,facet) {
		this.dataset=data
		this.xvar=xvar
		this.yvar=yvar
		this.group=group
	...
	Playfair.prototype.chart=function(options) {
		...
		// Otherwise, create axes appropriate to the data type
			...
			var xaxis=create_numerical_axis([Math.min(...all_x),Math.max(...all_x)])
			graph_obj.xarray=xaxis
		} else if(Object.prototype.toString.call(x_types[0])==='[object Date]'){
			var xaxis=create_date_axis([new Date(moment(Math.min(...all_x),["MM-DD-YYYY","MM/DD/YYYY","YYYY-MM-DD","MM-DD-YY","MM/DD/YY","MMMM YYYY","MMMM DD YYYY","MMMM DD, YYYY","MMMM, YYYY","YYYYqQ"],false),new Date(moment(Math.max(...all_x),["MM-DD-YYYY","MM/DD/YYYY","YYYY-MM-DD","MM-DD-YY","MM/DD/YY","MMMM YYYY","MMMM DD YYYY","MMMM DD, YYYY","MMMM, YYYY","YYYYqQ"],false)])
			graph_obj.xarray=xaxis
		}
	}
	...
	// handle stacked stuff, handle user defined axes, handle min and max limits
	// YOU ARE HERE YOU ARE HERE YOU ARE HERE YOU ARE HERE YOU ARE HERE YOU ARE HERE YOU ARE HERE YOU ARE HERE YOU ARE HERE YOU ARE HERE
