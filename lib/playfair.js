...
function draw_axes(playobj,xvar,yvar,shiftx,shifty) {
	...
	if (playobj.group!=='none'){
		...
		avail_width=playobj.width-playobj.left_margin-playobj.right_margin
		horizon_key_start_x=playobj.x+playobj.left_margin
		horizon_key_start_y=playobj.y+playobj.header_toppad+playobj.header_bottompad+playobj.head_height

		// available height for the key
		avail_height=playobj.height-playobj.footer_bottompad-playobj.logo_height-playobj.footer_toppad-playobj.header_toppad-playobj.header_bottompad-playobj.head_height
		vertical_key_start_y=playobj.y+playobj.header_toppad+playobj.header_bottompad+playobj.head_height
		...
		vertical_key_start_x=playobj.x+playobj.width-playobj.left_margin-longest
