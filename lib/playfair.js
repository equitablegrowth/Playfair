	...
	Playfair.prototype.barchart = function(orientation) {
		...
		if(orientation=='vertical'){
			...
			for (var i=0;i<xaxis.length;i++){
				...
				if(typeof this.group=='undefined'){
					// Why subtract 1 from the data_value? So the bars don't cover the axis.
					// a much better solution would be to just move the 0 line to the front after doing this
					// it is barchart specific though.
					if(data_value<0){
