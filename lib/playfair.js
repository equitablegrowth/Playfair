...
window.playfair = (function () {
	...
	Playfair.prototype.barchart = function(orientation) {
		...
		var graph_background=snapobj.rect(graph_obj.x,graph_obj.y+graph_obj.top_margin,graph_obj.width,graph_obj.height-(graph_obj.top_margin+logo_coords.height+graph_obj.footer_toppad)).attr({fill:this.chartfill})
...
function draw_axis(playfair_object,axis_type,variable) {
	// axis_type is either x or y (horizontal or vertical)
	// variable type is automatically detected
