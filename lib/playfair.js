	...
	Playfair.prototype.footer = function(logo,source,note,callback) {
		...
		if (this.logo!=0){
			...
			logo.node.addEventListener('load',function(){
				...
				if(note_coords.y2-graphobj.y+graphobj.height-logo_coords.height-graphobj.footer_bottompad+i*parseInt(graphobj.sourcesize)>graphobj.footer_height){
					graphobj.footer_height=note_coords.y2-graphobj.y+graphobj.height-logo_coords.height-graphobj.footer_bottompad+i*parseInt(graphobj.sourcesize)>graphobj.footer_height
				}
